    ...
    <>
        ...
        {isOpen && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-20  backdrop-blur-[20px]">
                <div className="max-w-[300px] sm:max-w-[600px] lg:max-w-[800px] relative min-h-[-600px]
                 bg-white rounded-pop-up-lm flex justify-center items-center flex-col px-7 sm:px-[67px] 
                 py-6 sm:py-[58px] gap-[13px] sm:gap-[25px] font-Montserrat">
                ...
                <div className="flex justify-center items-center flex-col  gap-[8px] sm:gap-[15px] w-4/5 lg:w-[56.25%] text-center">
                    ...
                    <img src="/bncc_launching.png" alt="" className='rounded-pop-up-sm' />
                    ...
                    className="px-6 sm:px-12 py-3 relative rounded-pop-up-sm bg-pop-up-primary text-white font-semibold text-[0.5rem] sm:text-xl
                                hover:bg-white hover:text-pop-up-primary hover:border-pop-up-primary border-[3px]"> <span className='default-text'>Go to Registration Site</span> <span className='hover-text absolute inset-0 flex items-center justify-center'>launching.bncc.net</span></a>
                </div> 
                </div>
            </div>
        )}
